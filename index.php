...
?>
<script>
    var tel= "echo $telphone=$fila['tel']?>";
    tel="521"+tel;
    </script>
...
<body>
    ...
    <footer>
        ...
        <div class="burbujas">
            ...
            <a href="https://api.whatsapp.com/send/?phone=+52<?php echo $telphone=$fila['tel'];?>text=Hola+que+tal+necesito+ayuda&app_absent=0" target="_blank"><img class="burbuja-whatsapp" src="img/whatsapp.jpeg" alt=""></a>
           
            <!-- Utilizar para PC, laptop Web.whatsapp-->
            <a href="https://web.whatsapp.com/send?phone=+52<?php echo $telphone=$fila['tel'];?>&text=¡Buen dia ...!" target="_blank"><img class="burbuja-whatsapp" src="img/whatsapp.jpeg" alt=""></a>
